...
<body class="with-welcome-text">
  <div class="container-scroller">
    ...
    <?php 
include ("./pages/samples/topbar.php");
?>
    <!-- partial -->
    <?php 
include ("./pages/samples/sidebar.php");
?>
      <!-- partial -->
  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
        ...
        <span class="menu-title"> <b>Products </span>
        <i class="menu-arrow"></i>
      </a>
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="../pages/ui-features/buttons.php">Add New Products</a></li>
          <li class="nav-item"> <a class="nav-link" href="../pages/ui-features/dropdowns.php"> View Products</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item nav-category"><b>Categories</li>
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="#form-elements" aria-expanded="false"
        aria-controls="form-elements">
        <i class="menu-icon mdi mdi-card-text-outline"></i>
        <span class="menu-title"><b>Category</span>
        <i class="menu-arrow"></i>
      </a>
      <div class="collapse" id="form-elements">
        <ul class="nav flex-column sub-menu">
        <li class="nav-item"><a class="nav-link" href="../pages/forms/basic_elements.php">Add Category</a></li>
          <li class="nav-item"><a class="nav-link" href="../pages/forms/basic_elements.php">View Category</a></li>
        </ul>
      </div>
    </li>
    <!-- <li class="nav-item">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="auth">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="./pages/samples/logout.php"> Sign Out </a></li>
        </ul>
      </div>
    </li>
