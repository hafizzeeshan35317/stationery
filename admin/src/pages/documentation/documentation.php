              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-12 pt-5">
                    <a class="btn btn-primary" href="../../assets/index.php"><i class="ti-home me-2"></i>Back to home</a>
                  </div>
                </div>
                <div class="row pt-5 mt-5">
                  <div class="col-12 pt-5 text-center">
                    ...
                    <h3 class="text-primary fw-light mt-5">
                      ...
                      <a href="http://bootstrapdash.com/demo/star-admin-pro/docs/documentation.php" target="_blank" class="text-danger d-block text-truncate">
                        http://bootstrapdash.com/demo/star-admin-pro/docs/documentation.php
                      </a>
                    </h3>
