...
gulp.task('serve', gulp.series('sass', function() {
    ...
    gulp.watch('../dist/pages/**/*.php').on('change', browserSync.reload);
...
gulp.task('serve:lite', function() {
    ...
    gulp.watch('../dist/index.php').on('change', browserSync.reload);
    gulp.watch('../dist/pages/**/*.php').on('change', browserSync.reload);
    gulp.watch('../dist/assets/js/*.js').on('change', browserSync.reload);
...
gulp.task('copyHTML', () => {
    return gulp.src('./pages/**/*.php').pipe(gulp.dest('../dist/pages/'))
})

gulp.task('copyIndex', () => {
    return gulp.src('./index.php').pipe(gulp.dest('../dist/'))
})
